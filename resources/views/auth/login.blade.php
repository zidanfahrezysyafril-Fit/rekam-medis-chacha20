<x-guest-layout>
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-sm text-slate-500 mt-2">Log in to access your secure encrypted dashboard.</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5">
        ...
        @if (Route::has('register'))
            <div class="text-center mt-6">
                <p class="text-sm text-slate-500">Don't have an account? <a href="{{ route('register') }}" class="font-bold text-blue-600 hover:text-blue-800 transition-colors">Register here</a></p>
            </div>
        @endif
    </form>
</x-guest-layout>
